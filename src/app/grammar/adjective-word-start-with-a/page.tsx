...
export default function AdjectiveWordStartWithA() {
  return (
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            <div className="bg-white rounded-2xl shadow-lg p-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="bg-gradient-to-br from-red-50 to-pink-50 p-6 rounded-xl border-l-4 border-red-400">
                  <h3 className="text-2xl font-semibold text-red-700 mb-4">Personality & Character</h3>
                  <div className="space-y-3">
                    <div className="bg-white p-3 rounded-lg">
                      <p className="font-semibold text-red-800">Amazing</p>
                      <p className="text-red-600 text-sm">Very surprising and impressive</p>
                    </div>
                    <div className="bg-white p-3 rounded-lg">
                      <p className="font-semibold text-red-800">Awesome</p>
                      <p className="text-red-600 text-sm">Extremely good and impressive</p>
                    </div>
                    <div className="bg-white p-3 rounded-lg">
                      <p className="font-semibold text-red-800">Attractive</p>
                      <p className="text-red-600 text-sm">Pleasing to look at</p>
                    </div>
                    <div className="bg-white p-3 rounded-lg">
                      <p className="font-semibold text-red-800">Active</p>
                      <p className="text-red-600 text-sm">Full of energy and movement</p>
                    </div>
                    <div className="bg-white p-3 rounded-lg">
                      <p className="font-semibold text-red-800">Adventurous</p>
                      <p className="text-red-600 text-sm">Willing to take risks</p>
                    </div>
                  </div>
                </div>

                <div className="bg-gradient-to-br from-pink-50 to-rose-50 p-6 rounded-xl border-l-4 border-pink-400">
                  <h3 className="text-2xl font-semibold text-pink-700 mb-4">Abilities & Qualities</h3>
                  <div className="space-y-3">
                    <div className="bg-white p-3 rounded-lg">
                      <p className="font-semibold text-pink-800">Able</p>
                      <p className="text-pink-600 text-sm">Having the power to do something</p>
                    </div>
                    <div className="bg-white p-3 rounded-lg">
                      <p className="font-semibold text-pink-800">Accurate</p>
                      <p className="text-pink-600 text-sm">Correct and precise</p>
                    </div>
                    <div className="bg-white p-3 rounded-lg">
                      <p className="font-semibold text-pink-800">Adaptable</p>
                      <p className="text-pink-600 text-sm">Able to change easily</p>
                    </div>
                    <div className="bg-white p-3 rounded-lg">
                      <p className="font-semibold text-pink-800">Affectionate</p>
                      <p className="text-pink-600 text-sm">Showing love and care</p>
                    </div>
                    <div className="bg-white p-3 rounded-lg">
                      <p className="font-semibold text-pink-800">Ambitious</p>
                      <p className="text-pink-600 text-sm">Having strong desire to succeed</p>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div className="bg-red-50 p-6 rounded-lg border-l-4 border-red-500">
              <h3 className="text-xl font-semibold mb-4 text-red-900">Notes:</h3>
          ...
          <div className="space-y-6">
            <div className="bg-white rounded-2xl shadow-lg p-6">
              ...
              <div className="space-y-3">
                ...
                <Link href="/grammar/adjective-start-with-letter-b" className="block text-red-600 hover:text-red-800 font-medium">
                  Adjectives Starting With B
                </Link>
                <Link href="/grammar/adjective-start-with-letter-z" className="block text-red-600 hover:text-red-800 font-medium">
