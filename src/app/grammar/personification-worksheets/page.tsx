...
export default function PersonificationWorksheets() {
  return (
          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            <div className="bg-white rounded-2xl shadow-lg p-8 border-l-4 border-violet-500">
              ...
              <p className="text-lg text-gray-700 leading-relaxed">
                Personification is a literary device that gives human characteristics to non-human things like animals, objects, or ideas. 
                It makes writing more vivid and engaging by making inanimate objects seem alive and relatable. 
                These worksheets will help you identify, create, and understand personification.
              </p>
            </div>
                ...
                <div className="bg-gradient-to-r from-violet-50 to-purple-50 p-6 rounded-xl">
                  ...
                  <div className="space-y-4">
                    <div className="bg-white p-4 rounded-lg">
                      <p className="mb-2">1. The wind whispered through the trees.</p>
                    ...
                    <div className="bg-white p-4 rounded-lg">
                      <p className="mb-2">2. The old car coughed and sputtered.</p>
                      <details className="mt-2">
                        <summary className="cursor-pointer text-violet-600 font-semibold">Show Answer</summary>
                    ...
                    <div className="bg-white p-4 rounded-lg">
                      <p className="mb-2">3. The sun smiled down on the children.</p>
                      <details className="mt-2">
                        <summary className="cursor-pointer text-violet-600 font-semibold">Show Answer</summary>
            ...
            <div className="bg-white rounded-2xl shadow-lg p-8">
              ...
              <div className="space-y-6">
                <div className="bg-gradient-to-r from-purple-50 to-fuchsia-50 p-6 rounded-xl">
                  ...
                  <div className="space-y-4">
                    <div className="bg-white p-4 rounded-lg">
                      <p className="mb-2">1. The clock _____ (impatiently)</p>
                      <details className="mt-2">
                    ...
                    <div className="bg-white p-4 rounded-lg">
                      <p className="mb-2">2. The door _____ (loudly)</p>
                      <details className="mt-2">
                        <summary className="cursor-pointer text-purple-600 font-semibold">Show Answer</summary>
                    ...
                    <div className="bg-white p-4 rounded-lg">
                      <p className="mb-2">3. The trees _____ (in the wind)</p>
                      <details className="mt-2">
                        <summary className="cursor-pointer text-purple-600 font-semibold">Show Answer</summary>
            ...
            <div className="bg-white rounded-2xl shadow-lg p-8">
              ...
              <div className="space-y-6">
                <div className="bg-gradient-to-r from-pink-50 to-rose-50 p-6 rounded-xl">
                  ...
                  <div className="space-y-4">
                    <div className="bg-white p-4 rounded-lg">
                      <p className="mb-2">1. &quot;The wind whispered&quot;</p>
                      <details className="mt-2">
                    ...
                    <div className="bg-white p-4 rounded-lg">
                      <p className="mb-2">2. &quot;The car coughed&quot;</p>
                      <details className="mt-2">
                        <summary className="cursor-pointer text-pink-600 font-semibold">Show Answer</summary>
                    ...
                    <div className="bg-white p-4 rounded-lg">
                      <p className="mb-2">3. &quot;Time flew by&quot;</p>
                      <details className="mt-2">
                        <summary className="cursor-pointer text-pink-600 font-semibold">Show Answer</summary>
          ...
          <div className="space-y-6">
            <div className="bg-white rounded-2xl shadow-lg p-6">
              ...
              <div className="space-y-3">
                <Link href="/grammar/figurative-language" className="block text-violet-600 hover:text-violet-800 font-medium">
                  Figurative Language
                </Link>
                <Link href="/grammar/metaphors" className="block text-violet-600 hover:text-violet-800 font-medium">
                  Metaphors
                </Link>
                <Link href="/grammar/similes" className="block text-violet-600 hover:text-violet-800 font-medium">
                  Similes
                </Link>
                <Link href="/grammar/literary-devices" className="block text-violet-600 hover:text-violet-800 font-medium">
                  Literary Devices
                </Link>
                <Link href="/grammar/poetry" className="block text-violet-600 hover:text-violet-800 font-medium">
                  Poetry
                </Link>
              </div>
            </div>
