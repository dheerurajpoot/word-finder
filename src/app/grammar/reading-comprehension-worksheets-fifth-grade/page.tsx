...
export default function ReadingComprehensionWorksheetsFifthGrade() {
  return (
      ...
      <div className="bg-gradient-to-r from-blue-600 via-indigo-600 to-purple-600 text-white py-16">
        <div className="container mx-auto px-4">
          ...
          <p className="text-xl text-center max-w-3xl mx-auto">
            Enhance reading skills with engaging comprehension activities for fifth graders
          </p>
        </div>
      </div>
          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            <div className="bg-white rounded-2xl shadow-lg p-8 border-l-4 border-blue-500">
              ...
              <p className="text-lg text-gray-700 leading-relaxed">
                Fifth grade reading comprehension worksheets are educational tools designed to help students 
                understand, analyze, and interpret written text. These worksheets include passages followed 
                by questions that test various reading skills such as main idea, inference, vocabulary, 
                and critical thinking. They help develop essential literacy skills for academic success.
              </p>
            </div>
            ...
            <div className="bg-white rounded-2xl shadow-lg p-8">
              ...
              <div className="space-y-6">
                <div className="border-l-4 border-blue-500 pl-6">
                  <h3 className="text-2xl font-semibold text-blue-700 mb-3">Main Idea and Details</h3>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div className="bg-blue-50 p-4 rounded-lg">
                      <p className="font-semibold text-blue-800">Main Idea</p>
                      <p className="text-blue-600">Identifying the central message</p>
                    </div>
                    <div className="bg-blue-50 p-4 rounded-lg">
                      <p className="font-semibold text-blue-800">Supporting Details</p>
                      <p className="text-blue-600">Finding evidence for the main idea</p>
                    </div>
                    <div className="bg-blue-50 p-4 rounded-lg">
                      <p className="font-semibold text-blue-800">Summary</p>
                      <p className="text-blue-600">Condensing key information</p>
                    </div>
                    <div className="bg-blue-50 p-4 rounded-lg">
                      <p className="font-semibold text-blue-800">Theme</p>
                      <p className="text-blue-600">Understanding the author&apos;s message</p>
                    </div>
                  </div>
                </div>

                <div className="border-l-4 border-indigo-500 pl-6">
                  <h3 className="text-2xl font-semibold text-indigo-700 mb-3">Inference and Analysis</h3>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div className="bg-indigo-50 p-4 rounded-lg">
                      <p className="font-semibold text-indigo-800">Making Inferences</p>
                      <p className="text-indigo-600">Drawing conclusions from text</p>
                    </div>
                    <div className="bg-indigo-50 p-4 rounded-lg">
                      <p className="font-semibold text-indigo-800">Character Analysis</p>
                      <p className="text-indigo-600">Understanding character traits</p>
                    </div>
                    <div className="bg-indigo-50 p-4 rounded-lg">
                      <p className="font-semibold text-indigo-800">Author&apos;s Purpose</p>
                      <p className="text-indigo-600">Identifying why the author wrote</p>
                    </div>
                    <div className="bg-indigo-50 p-4 rounded-lg">
                      <p className="font-semibold text-indigo-800">Point of View</p>
                      <p className="text-indigo-600">Understanding perspective</p>
                    </div>
                  </div>
                </div>

                <div className="border-l-4 border-purple-500 pl-6">
                  <h3 className="text-2xl font-semibold text-purple-700 mb-3">Vocabulary and Context</h3>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div className="bg-purple-50 p-4 rounded-lg">
                      <p className="font-semibold text-purple-800">Context Clues</p>
                      <p className="text-purple-600">Using surrounding text for meaning</p>
                    </div>
                    <div className="bg-purple-50 p-4 rounded-lg">
                      <p className="font-semibold text-purple-800">Word Meanings</p>
                      <p className="text-purple-600">Understanding unfamiliar words</p>
                    </div>
                    <div className="bg-purple-50 p-4 rounded-lg">
                      <p className="font-semibold text-purple-800">Figurative Language</p>
                      <p className="text-purple-600">Understanding metaphors and similes</p>
                    </div>
                    <div className="bg-purple-50 p-4 rounded-lg">
                      <p className="font-semibold text-purple-800">Multiple Meaning Words</p>
                      <p className="text-purple-600">Words with different meanings</p>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div className="bg-white rounded-2xl shadow-lg p-8">
              ...
              <div className="space-y-4">
                <div className="bg-gradient-to-r from-blue-50 to-indigo-50 p-6 rounded-xl border-l-4 border-blue-400">
                  <p className="text-lg">
                    <span className="font-semibold text-blue-700">Main Idea Practice:</span> Read a passage about ecosystems and identify the main idea and three supporting details.
                  </p>
                </div>
                
                <div className="bg-gradient-to-r from-indigo-50 to-purple-50 p-6 rounded-xl border-l-4 border-indigo-400">
                  <p className="text-lg">
                    <span className="font-semibold text-indigo-700">Inference Activity:</span> Read a story about a character&apos;s actions and infer their feelings and motivations.
                  </p>
                </div>
                
                <div className="bg-gradient-to-r from-purple-50 to-pink-50 p-6 rounded-xl border-l-4 border-purple-400">
                  <p className="text-lg">
                    <span className="font-semibold text-purple-700">Vocabulary Exercise:</span> Use context clues to determine the meaning of unfamiliar words in a science passage.
                  </p>
                </div>
                
                <div className="bg-gradient-to-r from-pink-50 to-rose-50 p-6 rounded-xl border-l-4 border-pink-400">
                  <p className="text-lg">
                    <span className="font-semibold text-pink-700">Compare and Contrast:</span> Read two passages about different animals and identify similarities and differences.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white rounded-2xl shadow-lg p-8">
              <h2 className="text-3xl font-bold text-gray-800 mb-6">
                Interactive Quiz 2: Inference Practice
              </h2>
              ...
              <div className="space-y-6">
                <div className="bg-gradient-to-r from-indigo-50 to-purple-50 p-6 rounded-xl">
                  ...
                  <div className="space-y-4">
                    <div className="bg-white p-4 rounded-lg">
                      <p className="mb-2">Sarah looked at her watch and started running. She had been reading in the library and lost track of time. The school bus would leave in five minutes, and she was still two blocks away.</p>
                      <details className="mt-2">
                        <summary className="cursor-pointer text-indigo-600 font-semibold">Show Answer</summary>
                        <p className="mt-2 text-gray-700">Answer: Sarah was worried about missing the school bus</p>
                      </details>
                    </div>
                    
                    <div className="bg-white p-4 rounded-lg">
                      <p className="mb-2">What can you infer about Sarah&apos;s feelings?</p>
                      <details className="mt-2">
                        <summary className="cursor-pointer text-indigo-600 font-semibold">Show Answer</summary>
          ...
          <div className="space-y-6">
            <div className="bg-white rounded-2xl shadow-lg p-6">
              ...
              <div className="space-y-3">
                ...
                <Link href="/grammar/reading-strategies" className="block text-blue-600 hover:text-blue-800 font-medium">
                  Reading Strategies
                </Link>
                <Link href="/grammar/vocabulary" className="block text-blue-600 hover:text-blue-800 font-medium">
                  Vocabulary
                </Link>
            ...
            <div className="bg-white rounded-2xl shadow-lg p-6">
              ...
              <div className="space-y-2 text-sm">
                <div className="flex justify-between">
                  ...
                  <span className="text-gray-600">4 main areas</span>
                </div>
                <div className="flex justify-between">
