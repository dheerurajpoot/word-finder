      ...
      <div className="container mx-auto px-4">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="text-center mb-12">
            ...
            <h1 className="text-4xl font-bold text-gray-800 mb-4">Word Unscrambler</h1>
            <p className="text-xl text-gray-600 mb-2">Turn jumbled letters into meaningful words</p>
            <p className="text-gray-500">Perfect for word games, puzzles, and brain training</p>
          </div>
          ...
          <Card className="mb-8 shadow-lg">
            <CardContent className="p-8">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                <div>
                  <label htmlFor="scrambled" className="block text-sm font-medium text-gray-700 mb-2">
                    Scrambled Letters
                  </label>
                  <Input
                    id="scrambled"
                    ...
                    value={scrambledWord}
                    onChange={(e) => setScrambledWord(e.target.value.toUpperCase())}
                    onKeyPress={(e) => e.key === "Enter" && handleUnscramble()}
              ...
              <div className="flex gap-4">
                ...
                >
                  ...
                  {loading ? "Unscrambling..." : "Unscramble Words"}
                </Button>
                  ...
                  {results.map((word, index) => (
                    ...
                    >
                      <div className="flex items-center justify-between mb-2">
                        ...
                        <Badge className={`text-xs ${getScoreColor(word.score)}`}>{word.score}</Badge>
                      </div>
              ...
              <CardContent>
                <div className="space-y-4">
                  <div className="flex items-center gap-3">
                    ...
                    <span className="text-sm">Enter your scrambled letters</span>
                  </div>
                  <div className="flex items-center gap-3">
                    <div className="w-8 h-8 bg-purple-100 rounded-full flex items-center justify-center text-purple-600 font-bold text-sm">
                      2
                    </div>
                    <span className="text-sm">Choose sorting and filtering options</span>
                  </div>
                  <div className="flex items-center gap-3">
                    <div className="w-8 h-8 bg-purple-100 rounded-full flex items-center justify-center text-purple-600 font-bold text-sm">
                      3
                    </div>
                    <span className="text-sm">Get instant results with scores</span>
                  </div>
                </div>
              </CardContent>
            </Card>
              ...
              <CardContent>
                <div className="space-y-3">
                  <div className="flex justify-between items-center p-2 bg-purple-50 rounded">
                    <span className="font-mono text-sm">DROW</span>
                    <span className="text-sm text-gray-600">→ WORD</span>
                  </div>
                  <div className="flex justify-between items-center p-2 bg-purple-50 rounded">
                    <span className="font-mono text-sm">EMAG</span>
                    <span className="text-sm text-gray-600">→ GAME</span>
                  </div>
                  <div className="flex justify-between items-center p-2 bg-purple-50 rounded">
                    <span className="font-mono text-sm">ZZULEP</span>
                    <span className="text-sm text-gray-600">→ PUZZLE</span>
                  </div>
                  <div className="flex justify-between items-center p-2 bg-purple-50 rounded">
                    <span className="font-mono text-sm">LEBBARCS</span>
                    <span className="text-sm text-gray-600">→ SCRABBLE</span>
                  </div>
                </div>
              </CardContent>
            </Card>
