...
export default function WordFindersPage() {
  const tools = [
    {
      title: "Word Finder",
      description: "Find words from your letters for Scrabble and Words with Friends",
      icon: Search,
      href: "/",
    ...
    <div className="min-h-screen bg-gray-50 py-12">
      <div className="container mx-auto px-4">
        <div className="max-w-6xl mx-auto">
          <h1 className="text-4xl font-bold text-center mb-8">Word Finder Tools</h1>
          <p className="text-xl text-center text-gray-600 mb-12">
            Powerful tools to help you find the perfect words for any game
          </p>
              ...
              return (
                <Card key={index} className="hover:shadow-lg transition-shadow">
                  ...
                  <CardContent>
                    ...
                    <Link href={tool.href}>
                      <Button className="w-full bg-green-500 hover:bg-green-600">Try {tool.title}</Button>
                    </Link>
                  </CardContent>
                </Card>
              )
