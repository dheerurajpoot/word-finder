...
export default function AnagramSolverPage() {
  ...
  const groupedAnagrams = anagrams.reduce(
    (acc, word) => {
      ...
      <div className="container mx-auto px-4">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="text-center mb-12">
            ...
            <h1 className="text-4xl font-bold text-gray-800 mb-4">Anagram Solver</h1>
            <p className="text-xl text-gray-600 mb-2">
              Unscramble letters to find all possible anagrams and word combinations
            </p>
            <p className="text-gray-500">Enter your letters and discover hidden words instantly</p>
          </div>
            ...
            <CardContent className="p-8">
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
                <div className="md:col-span-2">
                  <label htmlFor="letters" className="block text-sm font-medium text-gray-700 mb-2">
          ...
          {anagrams.length > 0 && (
            <div className="space-y-6">
              <div className="text-center">
                ...
                <p className="text-gray-600">Words you can make from "{letters}"</p>
              </div>
                      ...
                      <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-6 gap-3">
                        {words.map((word, index) => (
                          ...
                          >
                            ...
                            <div className="text-sm text-gray-500">{word.score} pts</div>
                          </div>
                        ))}
                      </div>
                    </CardContent>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  ...
                  <ul className="space-y-2 text-sm text-gray-600">
                    ...
                    <li>• Set minimum word length (2-15 letters)</li>
                    <li>• Get instant results with scoring</li>
                ...
                <div>
                  ...
                  <ul className="space-y-2 text-sm text-gray-600">
                    ...
                    <li>• Higher scores indicate rarer letters</li>
                    <li>• Perfect for word games and puzzles</li>
                  </ul>
                </div>
              </div>
            </CardContent>
